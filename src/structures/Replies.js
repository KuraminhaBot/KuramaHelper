...
module.exports = class Replies {
  static start() {
    ...
    ButtonInteraction.prototype.kuramaReply = function(content, emoji= "🔹", mentionUser = true) {
      return Replies.kuramaReply(this, content, emoji, mentionUser)
    }
    
    Interaction.prototype.kuramaReply = function(content, emoji= "🔹", mentionUser = true) {
      return Replies.kuramaReply(this, content, emoji, mentionUser)
    }
  ...
  static kuramaReply(ref, content, emoji= "🔹", mentionUser = true) {
    if (!content) content = ''
